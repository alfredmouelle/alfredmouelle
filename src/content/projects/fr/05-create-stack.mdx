...
- **Monorepo au choix** : un flag `--monorepo [turbo|nx]` (ou le prompt interactif) génère l'app dans `apps/web`, encapsulée dans une racine Turborepo ou Nx prête à l'emploi : scripts délégués à l'orchestrateur, workspaces, outputs de build par framework et git hooks hoistés.
